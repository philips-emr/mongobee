...
public class LockDao {
    ...
    private void createCollectionAndUniqueIndexIfNotExists(MongoDatabase db) {
        final Document indexKeys = new Document(KEY_PROP_NAME, INDEX_SORT_ASC);
    ...
    public boolean acquireLock(MongoDatabase db) {
        ...
        final Document insertObj = new Document(KEY_PROP_NAME, LOCK_ENTRY_KEY_VAL).append("status", "LOCK_HELD");
